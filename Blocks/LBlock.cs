...
{
    // Class representing the "L" Tetris block (reverse hook shape).
    public class LBlock : Block
    {
        public override int Id => 3; // Unique identifier for the "L" block.

        // Starting offset of the "L" block in the grid.
